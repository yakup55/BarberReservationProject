...
public ResponseEntity<MessageResponse> updateUserPassword(@RequestBody @Valid UpdateUserPassword updateUserPassword) {
	return service.updatePassword(updateUserPassword);
}
